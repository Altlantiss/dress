  ...
  location.href = 'http://www.dress.com/index.php/Home/Index/index';
        ...
        <div class="mainbox">
            <table class="main-table" id="edit-user-container">
                ...
                <tr>
                    <td>
                        <input type="text" class="edit" id="up-name" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-tel" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-qq" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-total_consumption" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-total_integral" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-esidual_integral" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-card_number" value="">
                    </td>
                    <td>
                        <input type="text" class="edit" id="up-discount" value="">
                    </td>
                    <td>
                        <span class="ctl ctl-edit" onclick="addUser()">增加会员</span>
                    </td>
                </tr>
            </table>
        </div>
...
<script type="text/javascript">
  ...
  function addUser() {
    $.ajax({
      type: 'post',
      url: 'http://www.dress.com/index.php/Home/User/add',
      dataType: 'json',
      data: {
        name: $('#up-name').val(),
        tel: $('#up-tel').val(),
